if(NOT TARGET dep::eigen3)
    ...
    if(AC_PATH_EIGEN3)
        set(dep_eigen3_PATH ${AC_PATH_EIGEN3})
        find_path(dep_eigen3_INCLUDE
            NAMES Eigen/Core
            PATHS ${dep_eigen3_PATH}
        )
    endif()
    if(dep_eigen3_INCLUDE)
        target_include_directories(dep_eigen3 INTERFACE $<BUILD_INTERFACE:${dep_eigen3_INCLUDE}>)
    else()
