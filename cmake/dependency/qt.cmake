if(NOT TARGET dep::qt)
    ...
    macro(dep_qt_add_executable PARAM_TARGET PARAM_SRC_FILES PARAM_TS_FILES)
        if(${QT_VERSION_MAJOR} GREATER_EQUAL 6)
            qt_create_translation(dep_qt_QM_FILES ${PARAM_SRC_FILES} ${PARAM_TS_FILES})
            qt_add_executable(${PARAM_TARGET} ${PARAM_SRC_FILES} ${dep_qt_QM_FILES})
        else()
            qt5_create_translation(dep_qt_QM_FILES ${PARAM_SRC_FILES} ${PARAM_TS_FILES})
