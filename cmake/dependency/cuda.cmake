...
if(NOT TARGET dep::cuda)
    ...
    add_library(dep_cuda INTERFACE IMPORTED)
    target_link_libraries(dep_cuda INTERFACE CUDA::cudart_static)
    if((CMAKE_CXX_COMPILER_ID MATCHES "MSVC" OR CMAKE_CXX_SIMULATE_ID MATCHES "MSVC") AND NOT AC_ENABLE_STATIC_CRT) #suppress warning
