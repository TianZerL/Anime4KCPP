...
namespace ac::core::cpu
{
    ...
    inline void conv3x3_generic(const Image& src, Image& dst, const float* kernels, const float* biases)
    {
    ...
    template <typename IN, typename OUT, int cin, int cout>
    inline void deconv2x2_generic(const Image& src, Image& dst, const float* kernels)
    {
