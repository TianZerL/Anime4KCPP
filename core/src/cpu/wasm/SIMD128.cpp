...
namespace ac::core::cpu
{
    ...
    void conv3x3_wasm_simd128_float(const Image& src, Image& dst, const float* kernels, const float* biases)
    {
    ...
    void conv3x3_wasm_simd128_cin1(const Image& src, Image& dst, const float* kernels, const float* biases)
    {
        int w = src.width(), h = src.height();
        int step = src.stride() / src.elementSize();
    ...
    template <typename OUT, int cin, int cout>
    void deconv2x2_wasm_simd128_float(const Image& src, Image& dst, const float* kernels)
    {
