...
kernel void conv3x3_1to8_identity(
    ...
    global const float* const restrict kernels,
    const int koffset,
    global const float* const restrict biases,
    const int boffset)
{
    ...
    float s[8];
    conv3x3_cin1(src, s, 8, kernels, koffset, biases, boffset, x, y);
    ...
    const float negative_slope)
{
    ...
    float s[8];
    conv3x3_cin8(src, s, 8, kernels, koffset, biases, boffset, x, y);
    ...
    const int boffset)
{
    ...
    float s[4];
    conv3x3_cin8(src, s, 4, kernels, koffset, biases, boffset, x, y);
