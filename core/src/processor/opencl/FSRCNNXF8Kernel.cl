    ...
    const int boffset)
{
    ...
    local float kptr[8 * 5 * 5 * 1];
    local float bptr[8];
    copy_to_local(kptr, kernels, 8 * 5 * 5 * 1);
    ...
    float s[8];
    conv5x5_cin1(src, s, 8, kptr, bptr, x, y);
