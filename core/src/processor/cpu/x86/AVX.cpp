...
namespace ac::core::cpu
{
    ...
    private:
        ...
        static AC_FORCE_INLINE void conv_kernel(const int sgroupIdx, const float** const rptr, __m256* const s, float* const out, const float* const kernels) noexcept
        {
...
#               endif
    ...
    void conv3x3_1to8_relu_avx(const Image& src, Image& dst, const float* kernels, const float* biases)
    {
        ...
        {
        case Image::UInt8:
            conv3x3_cin1<OpImplAVX<false>, DataType::UInt8, 8>(src, dst, kernels, biases, ReLU{});
            break;
        case Image::UInt16:
            conv3x3_cin1<OpImplAVX<false>, DataType::UInt16, 8>(src, dst, kernels, biases, ReLU{});
            break;
        case Image::Float16:
            conv3x3_cin1<OpImplAVX<false>, DataType::Float16, 8>(src, dst, kernels, biases, ReLU{});
            break;
        case Image::Float32:
            conv3x3_cin1<OpImplAVX<false>, DataType::Float32, 8>(src, dst, kernels, biases, ReLU{});
            break;
        }
    }
...
#   endif
    ...
    void deconv2x2_8to1_avx(const Image& src, Image& dst, const float* kernels)
    {
        ...
        {
        case Image::UInt8:
            deconv2x2<OpImplAVX<false>, DataType::UInt8, 8, 1>(src, dst, kernels);
            break;
        case Image::UInt16:
            deconv2x2<OpImplAVX<false>, DataType::UInt16, 8, 1>(src, dst, kernels);
            break;
        case Image::Float16:
            deconv2x2<OpImplAVX<false>, DataType::Float16, 8, 1>(src, dst, kernels);
            break;
        case Image::Float32:
            deconv2x2<OpImplAVX<false>, DataType::Float32, 8, 1>(src, dst, kernels);
            break;
        }
    }
    ...
    void conv3x3_1to8_prelu_avx(const Image& src, Image& dst, const float* kernels, const float* biases, const float* alphas)
    {
        ...
        {
        case Image::UInt8:
            conv3x3_cin1<OpImplAVX<false>, DataType::UInt8, 8>(src, dst, kernels, biases, PReLU{ alphas });
            break;
        case Image::UInt16:
            conv3x3_cin1<OpImplAVX<false>, DataType::UInt16, 8>(src, dst, kernels, biases, PReLU{ alphas });
            break;
        case Image::Float16:
            conv3x3_cin1<OpImplAVX<false>, DataType::Float16, 8>(src, dst, kernels, biases, PReLU{ alphas });
            break;
        case Image::Float32:
            conv3x3_cin1<OpImplAVX<false>, DataType::Float32, 8>(src, dst, kernels, biases, PReLU{ alphas });
            break;
        }
    }
    ...
    void conv3x3_1to8_identity_avx(const Image& src, Image& dst, const float* kernels, const float* biases)
    {
        ...
        {
        case Image::UInt8:
            conv3x3_cin1<OpImplAVX<false>, DataType::UInt8, 8>(src, dst, kernels, biases, Identity{});
            break;
        case Image::UInt16:
            conv3x3_cin1<OpImplAVX<false>, DataType::UInt16, 8>(src, dst, kernels, biases, Identity{});
            break;
        case Image::Float16:
            conv3x3_cin1<OpImplAVX<false>, DataType::Float16, 8>(src, dst, kernels, biases, Identity{});
            break;
        case Image::Float32:
            conv3x3_cin1<OpImplAVX<false>, DataType::Float32, 8>(src, dst, kernels, biases, Identity{});
            break;
        }
    }
...
#   ifdef AC_CORE_WITH_FMA
        if (simd::supportFMA())
        {
            ...
            {
            case Image::UInt8:
                conv3x3_identity_pixelshuffle_float<OpImplAVX<true>, DataType::UInt8, 8, 2>(src, dst, kernels, biases, ResidualArg{ id, 1.0f });
                break;
            case Image::UInt16:
                conv3x3_identity_pixelshuffle_float<OpImplAVX<true>, DataType::UInt16, 8, 2>(src, dst, kernels, biases, ResidualArg{ id, 1.0f });
                break;
            case Image::Float16:
                conv3x3_identity_pixelshuffle_float<OpImplAVX<true>, DataType::Float16, 8, 2>(src, dst, kernels, biases, ResidualArg{ id, 1.0f });
                break;
            case Image::Float32:
                conv3x3_identity_pixelshuffle_float<OpImplAVX<true>, DataType::Float32, 8, 2>(src, dst, kernels, biases, ResidualArg{ id, 1.0f });
                break;
            }
        }
        else
#   endif
        {
            ...
            {
            case Image::UInt8:
                conv3x3_identity_pixelshuffle_float<OpImplAVX<false>, DataType::UInt8, 8, 2>(src, dst, kernels, biases, nullptr);
                break;
            case Image::UInt16:
                conv3x3_identity_pixelshuffle_float<OpImplAVX<false>, DataType::UInt16, 8, 2>(src, dst, kernels, biases, nullptr);
                break;
            case Image::Float16:
                conv3x3_identity_pixelshuffle_float<OpImplAVX<false>, DataType::Float16, 8, 2>(src, dst, kernels, biases, nullptr);
                break;
            case Image::Float32:
                conv3x3_identity_pixelshuffle_float<OpImplAVX<false>, DataType::Float32, 8, 2>(src, dst, kernels, biases, nullptr);
                break;
            }
        }
    }
    ...
    void conv3x3_1to16_identity_avx(const Image& src, Image& dst, const float* kernels, const float* biases)
    {
        ...
        {
        case Image::UInt8:
            conv3x3_cin1<OpImplAVX<false>, DataType::UInt8, 16>(src, dst, kernels, biases, Identity{});
            break;
        case Image::UInt16:
            conv3x3_cin1<OpImplAVX<false>, DataType::UInt16, 16>(src, dst, kernels, biases, Identity{});
            break;
        case Image::Float16:
            conv3x3_cin1<OpImplAVX<false>, DataType::Float16, 16>(src, dst, kernels, biases, Identity{});
            break;
        case Image::Float32:
            conv3x3_cin1<OpImplAVX<false>, DataType::Float32, 16>(src, dst, kernels, biases, Identity{});
            break;
        }
    }
...
#   ifdef AC_CORE_WITH_FMA
        if (simd::supportFMA())
        {
            ...
            {
            case Image::UInt8:
                conv3x3_identity_pixelshuffle_float<OpImplAVX<true>, DataType::UInt8, 16, 2>(src, dst, kernels, biases, nullptr);
                break;
            case Image::UInt16:
                conv3x3_identity_pixelshuffle_float<OpImplAVX<true>, DataType::UInt16, 16, 2>(src, dst, kernels, biases, nullptr);
                break;
            case Image::Float16:
                conv3x3_identity_pixelshuffle_float<OpImplAVX<true>, DataType::Float16, 16, 2>(src, dst, kernels, biases, nullptr);
                break;
            case Image::Float32:
                conv3x3_identity_pixelshuffle_float<OpImplAVX<true>, DataType::Float32, 16, 2>(src, dst, kernels, biases, nullptr);
                break;
            }
        }
        else
#   endif
        {
            ...
            {
            case Image::UInt8:
                conv3x3_identity_pixelshuffle_float<OpImplAVX<false>, DataType::UInt8, 16, 2>(src, dst, kernels, biases, nullptr);
                break;
            case Image::UInt16:
                conv3x3_identity_pixelshuffle_float<OpImplAVX<false>, DataType::UInt16, 16, 2>(src, dst, kernels, biases, nullptr);
                break;
            case Image::Float16:
                conv3x3_identity_pixelshuffle_float<OpImplAVX<false>, DataType::Float16, 16, 2>(src, dst, kernels, biases, nullptr);
                break;
            case Image::Float32:
                conv3x3_identity_pixelshuffle_float<OpImplAVX<false>, DataType::Float32, 16, 2>(src, dst, kernels, biases, nullptr);
                break;
            }
        }
    }
    ...
    void conv3x3_1to32_identity_avx(const Image& src, Image& dst, const float* kernels, const float* biases)
    {
        ...
        {
        case Image::UInt8:
            conv3x3_cin1<OpImplAVX<false>, DataType::UInt8, 32>(src, dst, kernels, biases, Identity{});
            break;
        case Image::UInt16:
            conv3x3_cin1<OpImplAVX<false>, DataType::UInt16, 32>(src, dst, kernels, biases, Identity{});
            break;
        case Image::Float16:
            conv3x3_cin1<OpImplAVX<false>, DataType::Float16, 32>(src, dst, kernels, biases, Identity{});
            break;
        case Image::Float32:
            conv3x3_cin1<OpImplAVX<false>, DataType::Float32, 32>(src, dst, kernels, biases, Identity{});
            break;
        }
    }
...
#   ifdef AC_CORE_WITH_FMA
        if (simd::supportFMA())
        {
            ...
            {
            case Image::UInt8:
                conv3x3_identity_pixelshuffle_float<OpImplAVX<true>, DataType::UInt8, 32, 2>(src, dst, kernels, biases, nullptr);
                break;
            case Image::UInt16:
                conv3x3_identity_pixelshuffle_float<OpImplAVX<true>, DataType::UInt16, 32, 2>(src, dst, kernels, biases, nullptr);
                break;
            case Image::Float16:
                conv3x3_identity_pixelshuffle_float<OpImplAVX<true>, DataType::Float16, 32, 2>(src, dst, kernels, biases, nullptr);
                break;
            case Image::Float32:
                conv3x3_identity_pixelshuffle_float<OpImplAVX<true>, DataType::Float32, 32, 2>(src, dst, kernels, biases, nullptr);
                break;
            }
        }
        else
#   endif
        {
            ...
            {
            case Image::UInt8:
                conv3x3_identity_pixelshuffle_float<OpImplAVX<false>, DataType::UInt8, 32, 2>(src, dst, kernels, biases, nullptr);
                break;
            case Image::UInt16:
                conv3x3_identity_pixelshuffle_float<OpImplAVX<false>, DataType::UInt16, 32, 2>(src, dst, kernels, biases, nullptr);
                break;
            case Image::Float16:
                conv3x3_identity_pixelshuffle_float<OpImplAVX<false>, DataType::Float16, 32, 2>(src, dst, kernels, biases, nullptr);
                break;
            case Image::Float32:
                conv3x3_identity_pixelshuffle_float<OpImplAVX<false>, DataType::Float32, 32, 2>(src, dst, kernels, biases, nullptr);
                break;
            }
        }
    }
...
#   ifdef AC_CORE_WITH_FMA
        if (simd::supportFMA())
        {
            ...
            {
            case Image::UInt8:
                conv5x5_cin1<OpImplAVX<true>, DataType::UInt8, 8>(src, dst, kernels, biases, Identity{});
                break;
            case Image::UInt16:
                conv5x5_cin1<OpImplAVX<true>, DataType::UInt16, 8>(src, dst, kernels, biases, Identity{});
                break;
            case Image::Float16:
                conv5x5_cin1<OpImplAVX<true>, DataType::Float16, 8>(src, dst, kernels, biases, Identity{});
                break;
            case Image::Float32:
                conv5x5_cin1<OpImplAVX<true>, DataType::Float32, 8>(src, dst, kernels, biases, Identity{});
                break;
            }
        }
        else
#   endif
        {
            ...
            {
            case Image::UInt8:
                conv5x5_cin1<OpImplAVX<false>, DataType::UInt8, 8>(src, dst, kernels, biases, Identity{});
                break;
            case Image::UInt16:
                conv5x5_cin1<OpImplAVX<false>, DataType::UInt16, 8>(src, dst, kernels, biases, Identity{});
                break;
            case Image::Float16:
                conv5x5_cin1<OpImplAVX<false>, DataType::Float16, 8>(src, dst, kernels, biases, Identity{});
                break;
            case Image::Float32:
                conv5x5_cin1<OpImplAVX<false>, DataType::Float32, 8>(src, dst, kernels, biases, Identity{});
                break;
            }
        }
    }
...
#   ifdef AC_CORE_WITH_FMA
        if (simd::supportFMA())
        {
            ...
            {
            case Image::UInt8:
                conv3x3_identity_pixelshuffle_float<OpImplAVX<true>, DataType::UInt8, 8, 2>(src, dst, kernels, biases, nullptr);
                break;
            case Image::UInt16:
                conv3x3_identity_pixelshuffle_float<OpImplAVX<true>, DataType::UInt16, 8, 2>(src, dst, kernels, biases, nullptr);
                break;
            case Image::Float16:
                conv3x3_identity_pixelshuffle_float<OpImplAVX<true>, DataType::Float16, 8, 2>(src, dst, kernels, biases, nullptr);
                break;
            case Image::Float32:
                conv3x3_identity_pixelshuffle_float<OpImplAVX<true>, DataType::Float32, 8, 2>(src, dst, kernels, biases, nullptr);
                break;
            }
        }
        else
...
#   ifdef AC_CORE_WITH_FMA
        if (simd::supportFMA())
        {
            ...
            {
            case Image::UInt8:
                conv5x5_cin1<OpImplAVX<true>, DataType::UInt8, 16>(src, dst, kernels, biases, Identity{});
                break;
            case Image::UInt16:
                conv5x5_cin1<OpImplAVX<true>, DataType::UInt16, 16>(src, dst, kernels, biases, Identity{});
                break;
            case Image::Float16:
                conv5x5_cin1<OpImplAVX<true>, DataType::Float16, 16>(src, dst, kernels, biases, Identity{});
                break;
            case Image::Float32:
                conv5x5_cin1<OpImplAVX<true>, DataType::Float32, 16>(src, dst, kernels, biases, Identity{});
                break;
            }
        }
        else
#   endif
        {
            ...
            {
            case Image::UInt8:
                conv5x5_cin1<OpImplAVX<false>, DataType::UInt8, 16>(src, dst, kernels, biases, Identity{});
                break;
            case Image::UInt16:
                conv5x5_cin1<OpImplAVX<false>, DataType::UInt16, 16>(src, dst, kernels, biases, Identity{});
                break;
            case Image::Float16:
                conv5x5_cin1<OpImplAVX<false>, DataType::Float16, 16>(src, dst, kernels, biases, Identity{});
                break;
            case Image::Float32:
                conv5x5_cin1<OpImplAVX<false>, DataType::Float32, 16>(src, dst, kernels, biases, Identity{});
                break;
            }
        }
    }
