...
#               endif
    ...
    void conv3x3_1to8_relu_avx(const Image& src, Image& dst, const float* kernels, const float* biases)
    {
        ...
        case Image::UInt16:
            ...
            break;
        case Image::Float16:
            conv3x3_cin1<OpImplAVX<false>, half_float::half, 8>(src, dst, kernels, biases, ReLU{});
            break;
        case Image::Float32:
...
#   endif
    ...
    void deconv2x2_8to1_avx(const Image& src, Image& dst, const float* kernels)
    {
        ...
        case Image::UInt16:
            ...
            break;
        case Image::Float16:
            deconv2x2<OpImplAVX<false>, half_float::half, 8, 1>(src, dst, kernels);
            break;
        case Image::Float32:
    ...
    void conv3x3_1to8_prelu_avx(const Image& src, Image& dst, const float* kernels, const float* biases, const float* alphas)
    {
        ...
        case Image::UInt16:
            ...
            break;
        case Image::Float16:
            conv3x3_cin1<OpImplAVX<false>, half_float::half, 8>(src, dst, kernels, biases, PReLU{ alphas });
            break;
        case Image::Float32:
    ...
    void conv3x3_1to8_identity_avx(const Image& src, Image& dst, const float* kernels, const float* biases)
    {
        ...
        case Image::UInt16:
            ...
            break;
        case Image::Float16:
            conv3x3_cin1<OpImplAVX<false>, half_float::half, 8>(src, dst, kernels, biases, Identity{});
            break;
        case Image::Float32:
...
#   ifdef AC_CORE_WITH_FMA
        if (simd::supportFMA())
        {
            ...
            case Image::UInt16:
                ...
                break;
            case Image::Float16:
                conv3x3_identity_pixelshuffle_float<OpImplAVX<true>, half_float::half, 8, 2>(src, dst, kernels, biases, ResidualArg{ id, 1.0f });
                break;
            case Image::Float32:
...
#   endif
        {
            ...
            case Image::UInt16:
                ...
                break;
            case Image::Float16:
                conv3x3_identity_pixelshuffle_float<OpImplAVX<false>, half_float::half, 8, 2>(src, dst, kernels, biases, nullptr);
                break;
            case Image::Float32:
    ...
    void conv3x3_1to16_identity_avx(const Image& src, Image& dst, const float* kernels, const float* biases)
    {
        ...
        case Image::UInt16:
            ...
            break;
        case Image::Float16:
            conv3x3_cin1<OpImplAVX<false>, half_float::half, 16>(src, dst, kernels, biases, Identity{});
            break;
        case Image::Float32:
...
#   ifdef AC_CORE_WITH_FMA
        if (simd::supportFMA())
        {
            ...
            case Image::UInt16:
                ...
                break;
            case Image::Float16:
                conv3x3_identity_pixelshuffle_float<OpImplAVX<true>, half_float::half, 16, 2>(src, dst, kernels, biases, nullptr);
                break;
            case Image::Float32:
...
#   endif
        {
            ...
            case Image::UInt16:
                ...
                break;
            case Image::Float16:
                conv3x3_identity_pixelshuffle_float<OpImplAVX<false>, half_float::half, 16, 2>(src, dst, kernels, biases, nullptr);
                break;
            case Image::Float32:
    ...
    void conv3x3_1to32_identity_avx(const Image& src, Image& dst, const float* kernels, const float* biases)
    {
        ...
        case Image::UInt16:
            ...
            break;
        case Image::Float16:
            conv3x3_cin1<OpImplAVX<false>, half_float::half, 32>(src, dst, kernels, biases, Identity{});
            break;
        case Image::Float32:
...
#   ifdef AC_CORE_WITH_FMA
        if (simd::supportFMA())
        {
            ...
            case Image::UInt16:
                ...
                break;
            case Image::Float16:
                conv3x3_identity_pixelshuffle_float<OpImplAVX<true>, half_float::half, 32, 2>(src, dst, kernels, biases, nullptr);
                break;
            case Image::Float32:
...
#   endif
        {
            ...
            case Image::UInt16:
                ...
                break;
            case Image::Float16:
                conv3x3_identity_pixelshuffle_float<OpImplAVX<false>, half_float::half, 32, 2>(src, dst, kernels, biases, nullptr);
                break;
            case Image::Float32:
...
#   ifdef AC_CORE_WITH_FMA
        if (simd::supportFMA())
        {
            ...
            case Image::UInt16:
                ...
                break;
            case Image::Float16:
                conv5x5_cin1<OpImplAVX<true>, half_float::half, 8>(src, dst, kernels, biases, Identity{});
                break;
            case Image::Float32:
...
#   endif
        {
            ...
            case Image::UInt16:
                ...
                break;
            case Image::Float16:
                conv5x5_cin1<OpImplAVX<false>, half_float::half, 8>(src, dst, kernels, biases, Identity{});
                break;
            case Image::Float32:
...
#   ifdef AC_CORE_WITH_FMA
        if (simd::supportFMA())
        {
            ...
            case Image::UInt16:
                ...
                break;
            case Image::Float16:
                conv3x3_identity_pixelshuffle_float<OpImplAVX<true>, half_float::half, 8, 2>(src, dst, kernels, biases, nullptr);
                break;
            case Image::Float32:
...
#   ifdef AC_CORE_WITH_FMA
        if (simd::supportFMA())
        {
            ...
            case Image::UInt16:
                ...
                break;
            case Image::Float16:
                conv5x5_cin1<OpImplAVX<true>, half_float::half, 16>(src, dst, kernels, biases, Identity{});
                break;
            case Image::Float32:
...
#   endif
        {
            ...
            case Image::UInt16:
                ...
                break;
            case Image::Float16:
                conv5x5_cin1<OpImplAVX<false>, half_float::half, 16>(src, dst, kernels, biases, Identity{});
                break;
            case Image::Float32:
